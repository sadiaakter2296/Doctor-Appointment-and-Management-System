 ...
 */
export const useBounce = (options = {}) => {
  const {
    delay = 100,
    scale = 1.1,
    duration = 300,
 ...
 */
export const useBounceTrigger = (trigger, options = {}) => {
 ...
 */
export const useBounceHover = (options = {}) => {
  const bounceHook = useBounce(options);
 ...
 */
export const useBounceClick = (onClick, options = {}) => {
  const bounceHook = useBounce(options);
